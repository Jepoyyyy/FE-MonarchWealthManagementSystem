...
import { Wallet, Percent, TrendingUp, Clock, BarChart3 } from "lucide-react";
...
import type { AppUser, Product, Asset, Goal, FinancialProfile } from "~/types";
import { GOAL_MAX_MONTHS, GOAL_TYPE_CONFIG } from "~/data";
import { fmt, fmtPct, fmtDuration, fmtFull, projectedDate } from "~/utils";
